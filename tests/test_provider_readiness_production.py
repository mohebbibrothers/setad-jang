...
class TestHTTPOTPProvider:
    ...
    @override_settings(
        SMS_API_URL="https://sms.example.test/send", SMS_API_KEY="test-key", SMS_SENDER="SETAD"
    )
...
class TestProviderReadiness:
    ...
    @override_settings(
        OTP_SMS_PROVIDER="http", SMS_API_URL="https://sms.example.test/send", SMS_API_KEY="key"
    )
    ...
    @override_settings(
        MADADKAR_PAYMENT_PROVIDER="zarinpal", MADADKAR_ZARINPAL_MERCHANT_ID="merchant"
    )
