...
class TestSupportQueryPerformanceContracts:
    ...
    def test_user_ticket_detail_serializer_does_not_query_after_user_selector(self) -> None:
        ...
        prefetched = selectors.get_user_ticket_by_number(user_id=ticket.owner_id, ticket_number=ticket.ticket_number)
...
class TestSupportPermissionAndRouteContracts:
    ...
    def test_anonymous_user_cannot_create_ticket(self) -> None:
        ...
        response = APIClient().post(
            ...
            data={"ticket_type_id": ticket_type.pk, "subject": "مشکل ورود", "description": "امکان ورود به سایت را ندارم"},
            format="json",
        )
    ...
    def test_closed_ticket_remains_visible_to_owner_history(self) -> None:
        ...
        response = _client_for(ticket.owner).get(reverse("support_desk:user-ticket-detail", kwargs={"ticket_number": ticket.ticket_number}))
