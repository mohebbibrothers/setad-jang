...
class TestKindnessPublicAPI:
    ...
    def test_public_listing_list_filters_and_never_exposes_phone(self) -> None:
        ...
        published = PublishedNeedListingFactory(category=category, title="برنامه نویس لازم دارم", contact_phone_snapshot="+989120000000")
...
class TestKindnessContactRevealAPI:
    ...
    def test_anonymous_cannot_reveal_contact(self) -> None:
        ...
        response = APIClient().post(reverse("kindness_wall:listing-reveal-contact", kwargs={"slug": listing.slug}))
...
class TestKindnessUserListingAPI:
    ...
    def test_user_can_create_update_and_submit_listing(self) -> None:
        ...
        submit_response = client.post(reverse("kindness_wall:user-listing-submit", kwargs={"listing_id": listing_id}))
    ...
    def test_user_cannot_access_other_user_listing(self) -> None:
        ...
        response = _client_for(other).get(reverse("kindness_wall:user-listing-detail", kwargs={"listing_id": listing.pk}))
...
class TestKindnessBookmarkReportAndMatchesAPI:
    ...
    def test_bookmark_create_and_delete(self) -> None:
        ...
        create_response = client.post(reverse("kindness_wall:listing-bookmark", kwargs={"slug": listing.slug}))
        delete_response = client.delete(reverse("kindness_wall:listing-bookmark", kwargs={"slug": listing.slug}))
    ...
    def test_user_can_list_and_dismiss_own_match(self) -> None:
        ...
        dismiss_response = client.post(reverse("kindness_wall:user-match-dismiss", kwargs={"match_id": match.pk}))
...
class TestKindnessAdminAPI:
    ...
    def test_admin_can_approve_reject_suspend_restore_and_review_report(self) -> None:
        ...
        approve_response = client.post(reverse("kindness_wall:admin-listing-approve", kwargs={"listing_id": pending.pk}))
        ...
        restore_response = client.post(reverse("kindness_wall:admin-listing-restore", kwargs={"listing_id": pending.pk}))
        assert restore_response.status_code == status.HTTP_200_OK

        report = KindnessListingReport.objects.create(listing=pending, reported_by=KindnessUserFactory(), reason=ReportReason.OTHER)
