...
def test_core_r4j_routes_remain_available_after_case_removal():
    ...
    assert reverse("r4j:user-report-submit", kwargs={"criminal_id": 1}) == "/api/v1/r4j/criminals/1/reports/"
    assert reverse("r4j:user-bounty-set", kwargs={"criminal_id": 1}) == "/api/v1/r4j/criminals/1/bounty/"
