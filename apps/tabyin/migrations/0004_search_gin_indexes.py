...
ایندکس‌های expression جستجو برای جدول `tabyin_tabyincontent`:
...
_INDEX_NAMES = [
    "tabyin_tabyincontent_search_fts_idx",
    "tabyin_tabyincontent_search_trgm_title",
    "tabyin_tabyincontent_search_trgm_description",
]
...
def build_indexes(apps, schema_editor) -> None:
    ...
    model = apps.get_model("tabyin", "TabyinContent")
    statements = [
        fts_index_sql(
            model,
            index_name="tabyin_tabyincontent_search_fts_idx",
            fields=[
                SearchField("title", "A"),
        ...
        trigram_index_sql(
            model, index_name="tabyin_tabyincontent_search_trgm_title", field_name="title"
        ),
        trigram_index_sql(
            model,
            index_name="tabyin_tabyincontent_search_trgm_description",
...
class Migration(migrations.Migration):
    ...
    dependencies = [("tabyin", "0003_tabyin_user_submission_proxy")]
