...
class UserActivity(BaseModel):
    ...
    verb = models.CharField(
        max_length=40, choices=ActivityVerb.choices, default=ActivityVerb.NOTIFIED
    )
    ...
    visibility = models.CharField(
        max_length=20, choices=ActivityVisibility.choices, default=ActivityVisibility.PRIVATE
    )
