...
urlpatterns = [
    ...
    path("me/recommendations/", views.LMSUserLearningRecommendationView.as_view(), name="user-learning-recommendations"),
    ...
    path("admin/lessons/<int:lesson_id>/video-processing/", views.LMSAdminLessonVideoProcessingView.as_view(), name="admin-lesson-video-processing"),
    path("admin/lessons/<int:lesson_id>/video-processing/status/", views.LMSAdminLessonVideoProcessingStatusView.as_view(), name="admin-lesson-video-processing-status"),
