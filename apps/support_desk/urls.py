...
urlpatterns = [
    ...
    path("knowledge/articles/", views.SupportKnowledgeArticleListView.as_view(), name="knowledge-article-list"),
    path("knowledge/articles/recommend/", views.SupportKnowledgeRecommendView.as_view(), name="knowledge-article-recommend"),
    path("knowledge/articles/<str:slug>/", views.SupportKnowledgeArticleDetailView.as_view(), name="knowledge-article-detail"),
    ...
    path("admin/knowledge/articles/", views.SupportAdminKnowledgeArticleListCreateView.as_view(), name="admin-knowledge-article-list-create"),
    path("admin/knowledge/articles/<int:article_id>/", views.SupportAdminKnowledgeArticleDetailView.as_view(), name="admin-knowledge-article-detail"),
    path("admin/knowledge/articles/<int:article_id>/publish/", views.SupportAdminKnowledgeArticlePublishView.as_view(), name="admin-knowledge-article-publish"),
    path("admin/knowledge/articles/<int:article_id>/archive/", views.SupportAdminKnowledgeArticleArchiveView.as_view(), name="admin-knowledge-article-archive"),
    path("admin/knowledge/articles/<int:article_id>/use/", views.SupportAdminKnowledgeArticleUseView.as_view(), name="admin-knowledge-article-use"),
    ...
    path("admin/tickets/<str:ticket_number>/smart-replies/", views.SupportAdminTicketSmartReplyView.as_view(), name="admin-ticket-smart-replies"),
    path("admin/tickets/<str:ticket_number>/smart-replies/use/", views.SupportAdminTicketSmartReplyUseView.as_view(), name="admin-ticket-smart-reply-use"),
